...
const VERBS = /** @type {Record<string, string>} */ ({
    ...
    explore: '歩いて探索する', descendTo: '階段を掘って降りる', branchMine: 'ブランチマイニング', chopTree: '木を 1 本切り倒す', patrol: '巡回・警備', depositLogs: 'チェストに納品する', shelter: '穴を掘って籠もる', goToSurface: '地上へ出る', digDown: '掘り下げる', placeHere: '置く', stay: '待つ',
...
export function describeCommand(command) {
    ...
    if (['moveAway', 'stay', 'explore', 'branchMine', 'chopTree', 'depositLogs', 'patrol'].includes(m[1])) return verb;
